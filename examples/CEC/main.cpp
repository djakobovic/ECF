...
//
// this main() function optimizes a single CEC 2014 function (Id set in config file)
// function Ids: 1-30
//
...
//
// this main() function iterates over multiple CEC 2014 functions and optimizes each one in turn
// function Ids: 1-30
//
/*
int main(int argc, char **argv)
{
	// run for selected CEC functions
	for(uint function = 1; function <= 30; function++) {
		...
		XMLNode func = registry.getChildNodeWithAttribute("Entry", "key", "cec.function");
